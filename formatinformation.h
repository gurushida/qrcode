 ...
 * value representing the mask pattern used to encode data.
 *
 ...
 *
 * Returns 1 on success , 0 if the given bit matrix has a dimension incompatible
 * with a QR code or -1 if it was not possible to decode the format information.
 */
